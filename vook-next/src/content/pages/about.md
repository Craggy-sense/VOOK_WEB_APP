...
founder_title: Organizational and Personal Leadership Development
...
moses_bio: |2
   Moses Osagiede is a graduate of Obafemi Awolowo University, Ile-Ife, Nigeria, and the International Graduate School of Leadership in Manila, Philippines. He is a university lecturer in Leadership and Organizational Culture and serves in the Leader Transformation Department, where he mentors and coaches students while facilitating values-based courses that integrate character development with academic learning and practical application across diverse sectors of society.
...
core_team:
  ...
  - name: Jini Kingsley
    ...
    bio: |2-
       Kingsly Shei Jini is a leadership and entrepreneurship development practitioner based in Cameroon, with experience in governance, marketplace leadership, and faith integrated entrepreneurship across Africa. He serves as the Country Representative of CBMC Cameroon and sits on the CBMC Africa Board, contributing to leadership development and expansion initiatives across Francophone Africa.
      He is the Founder of GWOLF Africa, a platform focused on entrepreneurship development, mentorship, leadership training, and social impact initiatives. Through his work, he has trained and mentored entrepreneurs, ministry leaders, and young professionals across multiple African countries.
      Kingsly brings over 18 years of experience in microfinance leadership, business development, and infrastructure project coordination in Cameroon and Chad. His work focuses on practical African centered leadership, entrepreneurship, governance, and transformational capacity building.
      He is currently pursuing a PhD in Leadership Studies and regularly facilitates trainings, webinars, and mentorship sessions within academic, corporate, ministry, and entrepreneurial spaces across Africa.
partnerships:
  - title: Corporate Partnerships
    icon: fas fa-building
    desc: 'Working with organizations to deliver leadership development, professional training, and knowledge-sharing initiatives.'
  - title: Faith-Based Institutions
    icon: fas fa-church
    desc: 'Partnering to promote spiritual growth, leadership development, and practical life skills within faith communities.'
  - title: Academic Institutions
    icon: fas fa-university
    desc: 'Partnering with universities and colleges for research, workshops, seminars, and capacity-building programs.'
  - title: Industry Experts
    icon: fas fa-user-tie
    desc: 'Engaging professionals and practitioners to share insights through webinars, talks, masterclasses, and conferences.'
  - title: Publishers & Media
    icon: fas fa-book-open
    desc: 'Collaborating to produce and distribute books, vooks (video books), podcasts, magazines, and other multimedia content.'
