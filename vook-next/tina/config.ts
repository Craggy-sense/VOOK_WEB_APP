    ...
    collections: [
      {
        ...
        fields: [
          ...
          { type: "string", name: "why_choose_vvi", label: "Why Choose VVI?", ui: { component: "textarea" } },
          {
            ...
            ui: { itemProps: (item) => { return { label: item?.title || 'Feature Box' } } },
            fields: [
          ...
          { type: "string", name: "moses_bio", label: "Moses Bio", ui: { component: "textarea" } },
          {
            ...
            ui: { itemProps: (item) => { return { label: item?.name || 'Team Member' } } },
            fields: [
          ...
          },
          {
            ...
            ui: { itemProps: (item) => { return { label: item?.title || 'Partner' } } },
            fields: [
              { type: "string", name: "title", label: "Title" },
              { type: "string", name: "icon", label: "Icon (FontAwesome class)" },
              { type: "string", name: "desc", label: "Description" },
          ...
          },
          {
            ...
            ui: { itemProps: (item) => { return { label: item?.title || 'Community Group' } } },
            fields: [
              { type: "string", name: "title", label: "Title" },
              { type: "string", name: "icon", label: "Icon (FontAwesome class)" },
